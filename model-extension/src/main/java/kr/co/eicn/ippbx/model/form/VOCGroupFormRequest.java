...
public class VOCGroupFormRequest extends BaseForm {
    ...
    /**
     * @see kr.co.eicn.ippbx.model.enums.ProcessKind
     */
    @NotNull("진행여부")
    ...
    /**
     * @see kr.co.eicn.ippbx.model.enums.IsArsSms
     */
    @NotNull("진행종류")
    private String isArsSms = "ARS";
    /**
     * @see kr.co.eicn.ippbx.model.enums.VocGroupSender
     */
    @NotNull("진행자")
    private String sender = "MEMBER";
    private Integer arsResearchId;     //설문선택
    /**
     * @see kr.co.eicn.ippbx.model.enums.InOutTarget
     */
    ...
    /**
     * @see kr.co.eicn.ippbx.model.enums.InOutCallKind
     */
