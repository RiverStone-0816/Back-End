...
public class ConfInfoDetailResponse extends ConfInfoSummaryResponse {
    /**
     * @see kr.co.eicn.ippbx.model.enums.ConfInfoStatusType
     */
    ...
    /**
     * @see kr.co.eicn.ippbx.model.enums.ConfInfoIsRecord
     */
    private String isRecord;    //녹취여부(M:녹취함, S:녹취안함)
    /**
     * @see kr.co.eicn.ippbx.model.enums.ConfInfoIsMachineDetect
     */
