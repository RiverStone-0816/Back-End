...
import kr.co.eicn.ippbx.server.jooq.pds.Indexes;
import kr.co.eicn.ippbx.server.jooq.pds.Keys;
import kr.co.eicn.ippbx.server.jooq.pds.Pds;
import kr.co.eicn.ippbx.server.jooq.pds.tables.records.PdsResearchResultRecord;
import org.jooq.*;
