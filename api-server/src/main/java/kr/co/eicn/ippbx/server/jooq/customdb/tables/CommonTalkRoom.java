...
import kr.co.eicn.ippbx.server.jooq.customdb.tables.records.TalkRoomRecord;
...
public class CommonTalkRoom extends TableImpl<TalkRoomRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TALK_ROOM_COMPANY_ID, Indexes.TALK_ROOM_ROOM_ID, Indexes.TALK_ROOM_SENDER_KEY, Indexes.TALK_ROOM_SEQ, Indexes.TALK_ROOM_USER_KEY);
    }
