...
import kr.co.eicn.ippbx.server.jooq.customdb.tables.records.VocCustomListRecord;
import org.jooq.*;
...
public class CommonVocCustomList extends TableImpl<VocCustomListRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.VOC_CUSTOM_LIST_COMPANY_ID, Indexes.VOC_CUSTOM_LIST_INSERT_DATE, Indexes.VOC_CUSTOM_LIST_SEQ);
    }
