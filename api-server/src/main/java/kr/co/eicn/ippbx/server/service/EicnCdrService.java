...
@Service
public class EicnCdrService extends ApiBaseService implements ApplicationContextAware {
    protected final Logger logger = LoggerFactory.getLogger(EicnCdrService.class);
    private final Map<String, EicnCdrRepository> repositories = new HashMap<>();
    private ApplicationContext applicationContext;

    public EicnCdrRepository getRepository() {
        ...
        return repositories.computeIfAbsent(g.getUser().getCompanyId(), companyId -> {
            final EicnCdrRepository repository = new EicnCdrRepository(companyId);
