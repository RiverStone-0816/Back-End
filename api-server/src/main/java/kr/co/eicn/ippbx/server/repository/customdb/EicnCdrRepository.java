...
//        addField(TABLE.WAITING_DATE);
        addField(TABLE.DIALUP_DATE);
        addField(TABLE.HANGUP_DATE);
        addField(TABLE.DURATION);
        addField(TABLE.BILLSEC);
//        addField(TABLE.WAITSEC);
        addField(TABLE.IN_OUT);
        addField(TABLE.DCONTEXT);
//        addField(TABLE.PEER);
        addField(TABLE.SRC);
        addField(TABLE.DST);
//        addField(TABLE.CALLSTATUS);
...
//        addField(TABLE.CHANNEL);
//        addField(TABLE.DST_CHANNEL);
        addField(TABLE.INI_NUM);
        addField(TABLE.SECOND_NUM);
//        addField(TABLE.WORKTIME_YN);
//        addField(TABLE.STAT_YN);
        addField(TABLE.IVR_KEY);
//        addField(TABLE.QUEUE_STRATEGY);
//        addField(TABLE.QUEUE_SEQUENCE);
        addField(TABLE.CALLEE_HANGUP);
//        addField(TABLE.WEB_VOICE_INFO);
//        addField(TABLE.VIP_BLACK);
        addField(TABLE.USERID);
//        addField(TABLE.GROUP_CODE);
//        addField(TABLE.GROUP_TREE_NAME);
//        addField(TABLE.GROUP_LEVEL);
//        addField(TABLE.COMPANY_ID);
        addField(TABLE.HOST);
        addField(TABLE.HANGUP_CAUSE);
        addField(TABLE.CMP_CLICK_KEY);
        addField(TABLE.CMP_CLICK_FROM);
//        addField(TABLE.CMP_GROUP_ID);
//        addField(TABLE.CMP_CUSTOMID);
//        addField(TABLE.TURN_OVER_CNT);
        addField(TABLE.TURN_OVER_KIND);
        addField(TABLE.TURN_OVER_NUMBER);
//        addField(TABLE.TURN_OVER_UNIQUEID);
        addField(TABLE.ETC1);
        addField(TABLE.ETC2);
        addField(TABLE.ETC3);
        addField(TABLE.ETC4);
