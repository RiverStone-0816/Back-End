...
import kr.co.eicn.ippbx.server.jooq.customdb.tables.records.EicnCdrRecord;
...
public class CommonEicnCdr extends TableImpl<EicnCdrRecord> {
     ...
     */
    public CommonEicnCdr(String alias, Table<EicnCdrRecord> aliased) {
     ...
     * Create an aliased <code>CUSTOMDB.eicn_cdr_*</code> table reference
     */
    public CommonEicnCdr(Name alias, Table<EicnCdrRecord> aliased) {
        this(alias, aliased, null);
    }

    private CommonEicnCdr(Name alias, Table<EicnCdrRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
        this.tableName = alias.last();
    }

    public <O extends Record> CommonEicnCdr(CommonEicnCdr table, Table<O> child, ForeignKey<O, EicnCdrRecord> key) {
