...
import kr.co.eicn.ippbx.server.jooq.customdb.tables.MemoMsg;
import org.jooq.*;
...
public class CommonMemoMsg extends TableImpl<MemoMsgRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MEMO_MSG_INSERT_TIME, Indexes.MEMO_MSG_MESSAGE_ID, Indexes.MEMO_MSG_RECEIVE_USERID, Indexes.MEMO_MSG_SEND_USERID, Indexes.MEMO_MSG_SEQ);
    }
