...
import kr.co.eicn.ippbx.server.model.enums.ForwardKind;
...
public class PhoneApiController extends ApiBaseController {
    ...
    public ResponseEntity<JsonResult<PhoneInfoDetailResponse>> get(@PathVariable String peer) {
        ...
        final kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.SipBuddies sipBuddies = sipBuddiesRepository.findOne(SipBuddies.SIP_BUDDIES.NAME.eq(detail.getPeer()));
        if (sipBuddies != null)
