...
import static kr.co.eicn.ippbx.meta.jooq.eicn.tables.ConfRoom.CONF_ROOM;

@Getter
@Repository
public class ConfRoomRepository extends EicnBaseRepository<ConfRoom, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConfRoom, Integer> {
    ...
    public ConfRoomRepository(CompanyTreeRepository companyTreeRepository) {
        super(CONF_ROOM, CONF_ROOM.SEQ, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConfRoom.class);
        this.companyTreeRepository = companyTreeRepository;
        orderByFields.add(CONF_ROOM.SEQ.desc());
    }

    public Pagination<kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConfRoom> pagination(ConfRoomSearchRequest search) {
    ...
    public void insert(ConfRoomFormRequest form) {
        ...
        kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConfRoom record = new kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConfRoom();
