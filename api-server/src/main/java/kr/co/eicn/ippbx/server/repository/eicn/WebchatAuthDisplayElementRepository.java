...
public class WebchatAuthDisplayElementRepository extends EicnBaseRepository<kr.co.eicn.ippbx.meta.jooq.eicn.tables.WebchatAuthDispElement, WebchatAuthDispElement, Integer> {
    ...
    public WebchatAuthDisplayElementRepository() {
        ...
        orderByFields.add(WEBCHAT_AUTH_DISP_ELEMENT.SEQUENCE.asc());
    }
    ...
    public void insert(Integer blockId, List<WebchatAuthBlocKFormRequest.AuthParamInfo> form) {
        if (form.size() > 0) {
            InsertValuesStep8<WebchatAuthDispElementRecord, Integer, Integer, String, String, String, String, String, String> query = dsl.insertInto(WEBCHAT_AUTH_DISP_ELEMENT, WEBCHAT_AUTH_DISP_ELEMENT.AUTH_BLOCK_ID, WEBCHAT_AUTH_DISP_ELEMENT.SEQUENCE, WEBCHAT_AUTH_DISP_ELEMENT.INPUT_TYPE, WEBCHAT_AUTH_DISP_ELEMENT.TITLE, WEBCHAT_AUTH_DISP_ELEMENT.INPUT_PARAM_NAME, WEBCHAT_AUTH_DISP_ELEMENT.INPUT_DISPLAY_NAME, WEBCHAT_AUTH_DISP_ELEMENT.INPUT_NEED_YN, WEBCHAT_AUTH_DISP_ELEMENT.COMPANY_ID);
