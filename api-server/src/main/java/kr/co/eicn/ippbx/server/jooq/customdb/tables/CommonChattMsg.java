...
import kr.co.eicn.ippbx.server.jooq.customdb.tables.records.ChattMsgRecord;
import org.jooq.*;
...
public class CommonChattMsg extends TableImpl<ChattMsgRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CHATT_MSG_INSERT_TIME, Indexes.CHATT_MSG_ROOM_ID, Indexes.CHATT_MSG_SEQ, Indexes.CHATT_MSG_USERID);
    }
