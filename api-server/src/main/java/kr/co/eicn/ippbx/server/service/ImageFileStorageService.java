...
public class ImageFileStorageService extends FileSystemStorageService {
    public String uploadImage(Path path, MultipartFile image) {
        ...
        final String saveFileName = System.currentTimeMillis() + "_" + System.nanoTime() + "_" + UrlUtils.decode(cleanPath(Objects.requireNonNull(image.getOriginalFilename()))).replaceAll("[ ()]", "");
