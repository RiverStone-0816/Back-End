...
public class CommonStatVoc extends TableImpl<StatVocRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.STAT_VOC_COMPANY_ID, Indexes.STAT_VOC_PRIMARY, Indexes.STAT_VOC_RESEARCH_ID, Indexes.STAT_VOC_RESEARCH_TREE_PATH, Indexes.STAT_VOC_STAT_DATE, Indexes.STAT_VOC_STAT_HOUR, Indexes.STAT_VOC_USERID);
    }
