...
import kr.co.eicn.ippbx.server.jooq.customdb.tables.CommonChattMsgRead;
...
@Getter
public class ChattMsgReadRepository extends CustomDBBaseRepository<CommonChattMsgRead, kr.co.eicn.ippbx.server.jooq.customdb.tables.pojos.CommonChattMsgRead, String>  {
    ...
    public ChattMsgReadRepository(String companyId) {
        super(new CommonChattMsgRead(companyId), new CommonChattMsgRead(companyId).MESSAGE_ID, kr.co.eicn.ippbx.server.jooq.customdb.tables.pojos.CommonChattMsgRead.class);
        this.TABLE = new CommonChattMsgRead(companyId);
    }

    public List<kr.co.eicn.ippbx.server.jooq.customdb.tables.pojos.CommonChattMsgRead> findAll(String roomId) {
