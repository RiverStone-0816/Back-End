...
import kr.co.eicn.ippbx.server.jooq.eicn.tables.MohConfig;
...
@Getter
@Repository
public class MohConfigRepository extends EicnBaseRepository<MohConfig, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.MohConfig, Integer> {
	private final Logger logger = LoggerFactory.getLogger(MohListRepository.class);

	public MohConfigRepository() {
		super(MOH_CONFIG, MOH_CONFIG.ID, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.MohConfig.class);
	}
