...
import kr.co.eicn.ippbx.server.jooq.eicn.tables.TalkTemplate;
import kr.co.eicn.ippbx.server.model.entity.eicn.TalkTemplateEntity;
...
@Getter
@Repository
public class TalkTemplateRepository extends EicnBaseRepository<TalkTemplate, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkTemplate, Integer> {
	protected final Logger logger = LoggerFactory.getLogger(TalkTemplateRepository.class);

	TalkTemplateRepository() {
		super(TALK_TEMPLATE, TALK_TEMPLATE.SEQ, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkTemplate.class);
	}

	public Record insertOnGeneratedKey(TalkTemplateFormRequest form){
		final kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkTemplate record = new kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkTemplate();
