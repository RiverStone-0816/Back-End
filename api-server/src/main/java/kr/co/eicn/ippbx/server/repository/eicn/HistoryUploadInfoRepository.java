...
import static kr.co.eicn.ippbx.server.jooq.eicn.tables.HistoryUploadInfo.HISTORY_UPLOAD_INFO;

@Getter
@Repository
public class HistoryUploadInfoRepository extends EicnBaseRepository<HistoryUploadInfo, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.HistoryUploadInfo, String> {
