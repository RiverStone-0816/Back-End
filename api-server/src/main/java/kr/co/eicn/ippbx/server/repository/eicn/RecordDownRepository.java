...
@Getter
@Repository
public class RecordDownRepository extends EicnBaseRepository<RecordDown, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.RecordDown, Integer> {
	protected final Logger logger = LoggerFactory.getLogger(RecordEncRepository.class);

	public RecordDownRepository() {
		super(RECORD_DOWN, RECORD_DOWN.SEQ, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.RecordDown.class);
		orderByFields.add(RECORD_DOWN.REQUESTDATE.desc());
	}

	public List<kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.RecordDown> findAll(RecordDownSearchRequest search) {
