...
import kr.co.eicn.ippbx.server.jooq.eicn.tables.TalkScheduleGroupList;
...
@Getter
@Repository
public class TalkScheduleGroupListRepository extends EicnBaseRepository<TalkScheduleGroupList, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkScheduleGroupList, Integer> {
	...
	TalkScheduleGroupListRepository(PBXServerInterface pbxServerInterface, CacheService cacheService) {
		super(TALK_SCHEDULE_GROUP_LIST, TALK_SCHEDULE_GROUP_LIST.CHILD, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkScheduleGroupList.class);
		this.pbxServerInterface = pbxServerInterface;
		this.cacheService = cacheService;
	}

	public void insert(TalkScheduleGroupListFormRequest form) {
		final List<kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkScheduleGroupList> duplicatedTime =
		...
		final kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkScheduleGroupList record = new kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkScheduleGroupList();
