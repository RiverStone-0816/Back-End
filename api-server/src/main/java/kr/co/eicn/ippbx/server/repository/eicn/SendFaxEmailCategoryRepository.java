...
@Getter
@Repository
public class SendFaxEmailCategoryRepository extends EicnBaseRepository<SendCategory, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.SendCategory, String> {
