...
@Getter
@Repository
public class HolyInfoRepository extends EicnBaseRepository<HolyInfo, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.HolyInfo, Integer> {
	protected final Logger logger = LoggerFactory.getLogger(HolyInfoRepository.class);

	public HolyInfoRepository() {
		super(HOLY_INFO, HOLY_INFO.SEQ, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.HolyInfo.class);
	...
	public void insert(HolyInfoFormRequest form) {
		...
		final Optional<kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.HolyInfo> optionalDuplicatedCheck = findAll(
		...
		final kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.HolyInfo record = new kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.HolyInfo();
