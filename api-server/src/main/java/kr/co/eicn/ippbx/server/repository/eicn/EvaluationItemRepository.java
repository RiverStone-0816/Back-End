...
import kr.co.eicn.ippbx.server.jooq.eicn.tables.EvaluationItem;
...
@Getter
@Repository
public class EvaluationItemRepository extends EicnBaseRepository<EvaluationItem, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.EvaluationItem, Long> {
    protected final Logger logger = LoggerFactory.getLogger(EvaluationItemRepository.class);

    public EvaluationItemRepository() {
        super(EVALUATION_ITEM, EVALUATION_ITEM.ID, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.EvaluationItem.class);
    }

    public void insert(EvaluationWholeCategoryFormRequest form, final Long evaluationId) {
        final Optional<kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.EvaluationForm> optionalEvaluationForm = dsl.select().from(EVALUATION_FORM)
                .where(EVALUATION_FORM.COMPANY_ID.eq(getCompanyId())).and(EVALUATION_FORM.ID.eq(evaluationId))
                .fetchOptionalInto(kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.EvaluationForm.class);
