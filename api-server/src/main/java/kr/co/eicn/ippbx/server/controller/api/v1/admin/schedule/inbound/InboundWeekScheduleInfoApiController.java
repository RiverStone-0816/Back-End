...
public class InboundWeekScheduleInfoApiController extends ApiBaseController {
	...
	public ResponseEntity<JsonResult<List<SummaryNumber070Response>>> searchNumbers() {
		final List<kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.ScheduleInfo> scheduleInfos = repository.findAll(ScheduleInfo.SCHEDULE_INFO.TYPE.eq(ScheduleType.WEEK.getCode()));
