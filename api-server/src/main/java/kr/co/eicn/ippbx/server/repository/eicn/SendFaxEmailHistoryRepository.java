...
import kr.co.eicn.ippbx.server.jooq.eicn.tables.SendFaxEmail;
...
@Getter
@Repository
public class SendFaxEmailHistoryRepository extends EicnBaseRepository<SendFaxEmail, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.SendFaxEmail, Long> {
    ...
    public SendFaxEmailHistoryRepository() {
        super(SEND_FAX_EMAIL, SEND_FAX_EMAIL.ID, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.SendFaxEmail.class);
    }

    public Pagination<kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.SendFaxEmail> pagination(SendFaxEmailHistorySearchRequest search) {
