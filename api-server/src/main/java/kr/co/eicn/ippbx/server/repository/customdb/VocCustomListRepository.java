...
import kr.co.eicn.ippbx.server.jooq.customdb.tables.CommonVocCustomList;
...
import static kr.co.eicn.ippbx.server.jooq.customdb.tables.VocCustomList.VOC_CUSTOM_LIST;

@Getter
public class VocCustomListRepository extends CustomDBBaseRepository<CommonVocCustomList, kr.co.eicn.ippbx.server.jooq.customdb.tables.pojos.CommonVocCustomList, Integer> {
    ...
    public VocCustomListRepository(String table) {
        super(new CommonVocCustomList(table), new CommonVocCustomList(table).SEQ, kr.co.eicn.ippbx.server.jooq.customdb.tables.pojos.CommonVocCustomList.class);
