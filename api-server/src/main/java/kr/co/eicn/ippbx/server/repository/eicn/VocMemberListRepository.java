...
@Getter
@Repository
public class VocMemberListRepository extends EicnBaseRepository<VocMemberList, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.VocMemberList, Integer> {
    protected final Logger logger = LoggerFactory.getLogger(VocMemberListRepository.class);

    public VocMemberListRepository() {
        super(VOC_MEMBER_LIST, VOC_MEMBER_LIST.SEQ, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.VocMemberList.class);
    }
