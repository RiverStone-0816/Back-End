...
import static kr.co.eicn.ippbx.meta.jooq.eicn.Tables.CON_CS_CODE_INFO;

@Getter
@Repository
public class ConCsCodeInfoRepository extends EicnBaseRepository<ConCsCodeInfo, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConCsCodeInfo, Integer> {
    protected final Logger logger = LoggerFactory.getLogger(ConCsCodeInfoRepository.class);

    public ConCsCodeInfoRepository() {
        super(CON_CS_CODE_INFO, CON_CS_CODE_INFO.SEQ, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConCsCodeInfo.class);
    }
    ...
    public kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.ConCsCodeInfo findOne(Integer type, String fieldId) {
