...
import kr.co.eicn.ippbx.server.jooq.eicn.tables.TalkMemberList;
import kr.co.eicn.ippbx.server.model.entity.eicn.TalkMemberListEntity;
...
@Getter
@Repository
public class TalkMemberListRepository extends EicnBaseRepository<TalkMemberList, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkMemberList, Integer> {
	protected final Logger logger = LoggerFactory.getLogger(TalkMemberListRepository.class);

	public TalkMemberListRepository() {
		super(TALK_MEMBER_LIST, TALK_MEMBER_LIST.SEQ, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.TalkMemberList.class);
	}
