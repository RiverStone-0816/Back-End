...
@Getter
@Repository
public class TalkMentRepository extends EicnBaseRepository<TalkMent, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.TalkMent, Integer> {
	protected final Logger logger = LoggerFactory.getLogger(TalkMentRepository.class);

	TalkMentRepository() {
		super(TALK_MENT, TALK_MENT.SEQ, kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.TalkMent.class);
	}

	public Record insertOnGeneratedKey(TalkMentFormRequest form) {
		final kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.TalkMent record = new kr.co.eicn.ippbx.meta.jooq.eicn.tables.pojos.TalkMent();
