...
import kr.co.eicn.ippbx.server.jooq.eicn.tables.ContextInfo;
...
@Getter
@Repository
public class ContextInfoRepository extends EicnBaseRepository<ContextInfo, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.ContextInfo, Integer> {
    protected final Logger logger = LoggerFactory.getLogger(ContextInfoRepository.class);

    public ContextInfoRepository() {
        super(CONTEXT_INFO, CONTEXT_INFO.SEQ, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.ContextInfo.class);
        orderByFields.add(CONTEXT_INFO.NAME.asc());
    }

    public void insert(ContextInfoFormRequest form) {
        final kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.ContextInfo entity = findOne(CONTEXT_INFO.CONTEXT.eq(form.getContext()));
    ...
    public kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.ContextInfo findOneByContext(String context) {
