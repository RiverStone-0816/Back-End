...
import static kr.co.eicn.ippbx.server.jooq.eicn.tables.DashboardViewList.DASHBOARD_VIEW_LIST;

@Getter
@Repository
public class DashboardViewListRepository extends EicnBaseRepository<DashboardViewList, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.DashboardViewList, Integer> {
	...
	public DashboardViewListRepository() {
		super(DASHBOARD_VIEW_LIST, DASHBOARD_VIEW_LIST.SEQ, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.DashboardViewList.class);
	}
