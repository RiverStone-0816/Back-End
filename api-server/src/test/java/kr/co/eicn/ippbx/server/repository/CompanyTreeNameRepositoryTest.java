...
@Getter
@Repository
public class CompanyTreeNameRepositoryTest extends EicnBaseRepository<CompanyTreeLevelName, kr.co.eicn.ippbx.server.jooq.eicn.tables.pojos.CompanyTreeLevelName, Integer> {
