...
@Slf4j
public class MultiCodeApiControllerTest extends BaseControllerTest {
    private final String TEST_URL = "/api/v1/admin/application/code/multi";
...
//    @Test
    public void put() throws Exception {
        ...
        final MvcResult result = this.mockMvc.perform(RestDocumentationRequestBuilders.put(TEST_URL + "/type/{type}/field/{fieldId}/code", 2, "CON_CODE_2")
