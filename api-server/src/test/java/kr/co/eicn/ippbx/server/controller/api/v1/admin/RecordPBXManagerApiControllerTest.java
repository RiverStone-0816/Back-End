...
@Slf4j
public class RecordPBXManagerApiControllerTest extends BaseControllerTest {
	private final String TEST_URL = "/api/v1/admin/record/remote-file";
...
//	@Test
	...
	public void delete() throws Exception {
		this.mockMvc.perform(RestDocumentationRequestBuilders.delete(TEST_URL)
				.param("fileName", "disk.tar.gz")
				.with(new JwtRequestPostProcessor()))
				.andExpect(status().isOk())
...
//	@Test
	...
	public void resource() throws Exception {
		this.mockMvc.perform(RestDocumentationRequestBuilders.get(TEST_URL + "/resource")
				...
				.param("fileName", "2019_12_15.tar.gz")
