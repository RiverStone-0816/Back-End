...
@Log4j2
public class TalkStatisticsHourlyApiControllerTest extends BaseControllerTest {
    private final String TEST_URL = "/api/v1/admin/talk/statistics/hourly";

    private FieldDescriptor[] hourlyStatTalkResponse = new FieldDescriptor[]{
...
//                .param("endDate", "")
//                .param("endHour","")
//                .param("senderKey", "28ee2687812321c674b2453cbd62c121bea349d4")
                )
                .andDo(print())
                ...
                .andDo(document.document(
                        requestParameters(
                                ...
                                parameterWithName("startHour").description("시작시간").optional(),
                                parameterWithName("endDate").description("종료일").optional(),
                                parameterWithName("endHour").description("종료시간").optional(),
                        ...
                        responseFields(responseFields)
                                ...
                                .andWithPrefix("data[]",hourlyStatTalkResponse)
                ))
                .andReturn();
    }
}
