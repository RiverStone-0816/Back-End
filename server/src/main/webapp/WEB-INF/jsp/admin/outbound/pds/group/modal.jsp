...
<%--@elvariable id="queues" type="java.util.List<kr.co.eicn.ippbx.server.model.dto.eicn.SummaryPDSQueueNameResponse>"--%>
<%--@elvariable id="commonFields" type="java.util.List<kr.co.eicn.ippbx.server.model.dto.eicn.SummaryCommonFieldResponse>"--%>
<%--@elvariable id="researchList" type="java.util.Map<kr.co.eicn.ippbx.server.model.dto.eicn.SummaryResearchListResponse>"--%>
