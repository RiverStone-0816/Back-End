...
<div class="header">BlackList업로드</div>

<div class="content rows scrolling">
    <div class="ui grid">
        <div class="row">
            <div class="four wide column"><label class="control-label">등급유형</label></div>
            <div class="twelve wide column"><form:hidden path="gradeType"/>BlackList</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="twelve wide column">
                <div class="twelve wide column">
                    ...
                    <text style="display: inline-block; margin-right: 1em;">특정큐 선택[B]</text>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="twelve wide column">
                ...
                <div class="twelve wide column">
                    주의: 해당 번호가 VIP에 등록되어 있다면 VIP에서 삭제됩니다.
                </div>
            </div>
        </div>
    </div>
...
window.doneUploadExcelFile = function () {
    modal.find('[name=gradeType]').val('BLACK');
