...
<%--@elvariable id="search" type="kr.co.eicn.ippbx.server.model.search.PhoneSearchRequest"--%>
<%--@elvariable id="pagination" type="kr.co.eicn.ippbx.front.util.page.Pagination<kr.co.eicn.ippbx.server.model.dto.eicn.PhoneInfoSummaryResponse>"--%>
<%--@elvariable id="licenseInfo" type="kr.co.eicn.ippbx.server.model.LicenseInfo"--%>

<%@ page import="kr.co.eicn.ippbx.server.model.enums.ForwardWhen" %>
