...
<%--@elvariable id="entity" type="kr.co.eicn.ippbx.server.model.dto.eicn.PersonDetailResponse"--%>
<%--@elvariable id="form" type="kr.co.eicn.ippbx.server.model.form.PersonFormRequest"--%>

<%@ page import="kr.co.eicn.ippbx.server.model.enums.RecordingAuthorityType" %>
<%@ page import="kr.co.eicn.ippbx.server.model.enums.DataSearchAuthorityType" %>
