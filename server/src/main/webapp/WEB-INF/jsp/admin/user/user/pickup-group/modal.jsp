...
<%--@elvariable id="pbxServers" type="java.util.List<kr.co.eicn.ippbx.server.model.dto.eicn.SummaryCompanyServerResponse>"--%>

<%--@elvariable id="form" type="kr.co.eicn.ippbx.server.model.form.PickUpGroupFormRequest"--%>
