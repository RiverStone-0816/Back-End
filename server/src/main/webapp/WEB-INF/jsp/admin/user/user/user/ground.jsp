...
<%--@elvariable id="pagination" type="kr.co.eicn.ippbx.front.util.page.Pagination<kr.co.eicn.ippbx.server.model.dto.eicn.PersonSummaryResponse>"--%>
<%--@elvariable id="searchOrganizationNames" type="java.util.List"--%>
<%--@elvariable id="search" type="kr.co.eicn.ippbx.server.model.search.PersonSearchRequest"--%>
