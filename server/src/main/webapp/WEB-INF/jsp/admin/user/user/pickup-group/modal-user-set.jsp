...
<%--@elvariable id="entity" type="kr.co.eicn.ippbx.server.model.dto.eicn.PickUpGroupDetailResponse"--%>
<%--@elvariable id="form" type="kr.co.eicn.ippbx.server.model.form.PickUpGroupFormUpdateRequest"--%>

<form:form commandName="form" cssClass="ui modal -json-submit" data-method="put" action="${pageContext.request.contextPath}/api/pickup-group/${entity.groupcode}"
