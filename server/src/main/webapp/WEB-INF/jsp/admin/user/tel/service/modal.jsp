...
<%--@elvariable id="entity" type="kr.co.eicn.ippbx.server.model.dto.eicn.ServiceListDetailResponse"--%>
<%--@elvariable id="numbers" type="java.util.List<kr.co.eicn.ippbx.server.model.dto.eicn.NumberSummaryResponse>"--%>
<%--@elvariable id="form" type="kr.co.eicn.ippbx.server.model.form.ServiceListFormRequest"--%>
