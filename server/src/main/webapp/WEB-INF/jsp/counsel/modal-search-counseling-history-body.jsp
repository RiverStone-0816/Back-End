...
<div class="sub-content ui container fluid unstackable" id="modal-search-counseling-history-body">
    <form:form id="search-counseling-history-form" commandName="search" method="get" class="panel panel-search -ajax-loader"
...
<script>
    ...
    (function () {
        ...
        modal.find('.-popup-records').click(function (event) {
            ...
            popupReceivedHtml(contextPath + '/admin/application/maindb/result/' + $this.attr('data-id') + '/modal-records', 'modal-records').done(function (html) {
