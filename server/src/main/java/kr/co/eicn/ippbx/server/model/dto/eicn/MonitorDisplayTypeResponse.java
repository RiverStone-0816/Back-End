...
public class MonitorDisplayTypeResponse {
    ...
    /**
     * @see kr.co.eicn.ippbx.server.model.enums.DesignType
     */
    private String designType;  //사용디자인
    /**
     * @see kr.co.eicn.ippbx.server.model.enums.DisplayData
     */
    private String displayData; //표시데이터
    /**
     * @see kr.co.eicn.ippbx.server.model.enums.SlidingYn
     */
