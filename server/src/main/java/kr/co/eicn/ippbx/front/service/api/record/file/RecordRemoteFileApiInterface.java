...
@Service
public class RecordRemoteFileApiInterface extends ApiServerInterface {
    private static final Logger logger = LoggerFactory.getLogger(RecordRemoteFileApiInterface.class);

    private static final String subUrl = "/api/v1/admin/record/remote-file/";
