...
import kr.co.eicn.ippbx.server.model.dto.eicn.SummaryTalkScheduleInfoResponse;
import kr.co.eicn.ippbx.server.model.dto.eicn.SummaryTalkServiceResponse;
import kr.co.eicn.ippbx.server.model.dto.eicn.TalkScheduleInfoDetailResponse;
...
@Service
public class TalkDayScheduleApiInterface extends ApiServerInterface {
    private static final Logger logger = LoggerFactory.getLogger(TalkDayScheduleApiInterface.class);
    private static final String subUrl = "/api/v1/admin/talk/schedule/day/";
    ...
    public void post(DayTalkScheduleInfoFormRequest form) throws IOException, ResultFailException {
        post(subUrl, form);
    }
    ...
    public void holyPost(HolyTalkScheduleInfoFormRequest form) throws IOException, ResultFailException {
