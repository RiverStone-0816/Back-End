...
public class CommonResultCustomInfo extends TableImpl<ResultCustomInfoRecord> {
	 ...
	 */
	public final TableField<ResultCustomInfoRecord, String> RS_IMG_1 = createField(DSL.name("RS_IMG_1"), org.jooq.impl.SQLDataType.VARCHAR(100).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

	/**
	 * The column <code>CUSTOMDB.result_custom_info.RS_IMG_2</code>.
	 */
	public final TableField<ResultCustomInfoRecord, String> RS_IMG_2 = createField(DSL.name("RS_IMG_2"), org.jooq.impl.SQLDataType.VARCHAR(100).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

	/**
	 * The column <code>CUSTOMDB.result_custom_info.RS_IMG_3</code>.
	 */
	public final TableField<ResultCustomInfoRecord, String> RS_IMG_3 = createField(DSL.name("RS_IMG_3"), org.jooq.impl.SQLDataType.VARCHAR(100).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
