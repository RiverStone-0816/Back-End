...
public class PersonFormUpdateRequest extends BaseForm {
	...
	/**
	 * @see kr.co.eicn.ippbx.server.model.enums.PersonPausedStatus
	 */
	...
	/**
	 * @see kr.co.eicn.ippbx.server.model.enums.RecordingAuthorityType
	 */
	...
	public boolean validate(BindingResult bindingResult) {
		...
		if(!isNotEmpty(isPds))
			isPds = "N";
		if(!isNotEmpty(isTalk))
			isTalk = "N";
		if(!isNotEmpty(isEmail))
			isEmail = "N";
		if(!isNotEmpty(isStat))
			isStat = "N";
		if(!isNotEmpty(isChatt))
			isChatt = "N";
