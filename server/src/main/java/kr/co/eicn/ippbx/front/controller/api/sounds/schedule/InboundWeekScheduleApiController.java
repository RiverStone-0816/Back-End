...
@RestController
@RequestMapping(value = "api/inbound-week-schedule", produces = MediaType.APPLICATION_JSON_VALUE)
public class InboundWeekScheduleApiController extends ApiBaseController {
    private static final Logger logger = LoggerFactory.getLogger(InboundWeekScheduleApiController.class);
     ...
     */
    @PostMapping("")
    public void post(@Valid @RequestBody ScheduleInfoFormRequest form, BindingResult bindingResult) throws IOException, ResultFailException {
    ...
    public void updateType(@Valid @RequestBody ScheduleInfoUpdateFormRequest form, BindingResult bindingResult, @PathVariable Integer seq) throws IOException, ResultFailException {
