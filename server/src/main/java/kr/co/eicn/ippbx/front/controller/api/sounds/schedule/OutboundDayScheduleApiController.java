...
@RestController
@RequestMapping(value = "api/outbound-day-schedule", produces = MediaType.APPLICATION_JSON_VALUE)
public class OutboundDayScheduleApiController extends ApiBaseController {
    private static final Logger logger = LoggerFactory.getLogger(OutboundDayScheduleApiController.class);
     ...
     */
    @PostMapping("")
    public void post(@Valid @RequestBody DayOutScheduleSeedFormRequest form, BindingResult bindingResult) throws IOException, ResultFailException {
     ...
     */
    @PutMapping("{parent}")
    public void update(@Valid @RequestBody DayOutScheduleSeedFormRequest form, BindingResult bindingResult, @PathVariable Integer parent) throws IOException, ResultFailException {
