...
import kr.co.eicn.ippbx.front.service.EnumConverter;
import kr.co.eicn.ippbx.front.service.FileService;
import kr.co.eicn.ippbx.front.service.storage.SessionStorage;
import kr.co.eicn.ippbx.front.util.CodeHasable;
...
public class RequestGlobal {
    ...
    public <C> String messageOf(String enumClassName, C code) {
        return enumConverter.messageOf(enumClassName, code);
    }

    public <E extends Enum<E> & CodeHasable<C>, C> E of(String enumClassName, C code) {
        return enumConverter.of(enumClassName, code);
    }
