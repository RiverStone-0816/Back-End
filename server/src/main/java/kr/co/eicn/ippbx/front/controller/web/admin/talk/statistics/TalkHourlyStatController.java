...
@LoginRequired
@Controller
@RequestMapping("admin/talk/statistics/hourly")
public class TalkHourlyStatController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(TalkHourlyStatController.class);

    @Autowired
    private TalkHourlyStatApiInterface apiInterface;
    @Autowired
    ...
    public String page(Model model, @ModelAttribute("search") TalkStatisticsHourlySearchRequest search) throws IOException, ResultFailException {
        final List<TalkStatisticsHourlyResponse> list = apiInterface.list(search);
        ...
        return "admin/talk/statistics/hourly/ground";
    }
