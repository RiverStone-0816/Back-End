...
@LoginRequired
@Controller
@RequestMapping("admin/record/file/remote-file")
public class RecordRemoteFileController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(RecordRemoteFileController.class);
    ...
    public String page(Model model) throws IOException, ResultFailException {
        ...
        return "admin/record/file/remote-file/ground";
    }
}
