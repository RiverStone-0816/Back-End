...
public class VocResearchResult extends TableImpl<VocResearchResultRecord> {

    private static final long serialVersionUID = -2055435718;
    ...
    public VocResearchResult() {
        this(DSL.name("voc_research_result"), null);
    }

    /**
     * Create an aliased <code>CUSTOMDB.voc_research_result</code> table reference
     */
    public VocResearchResult(String alias) {
        this(DSL.name(alias), VOC_RESEARCH_RESULT);
    }

    /**
     * Create an aliased <code>CUSTOMDB.voc_research_result</code> table reference
     */
    public VocResearchResult(Name alias) {
        this(alias, VOC_RESEARCH_RESULT);
    }

    private VocResearchResult(Name alias, Table<VocResearchResultRecord> aliased) {
        this(alias, aliased, null);
    }

    private VocResearchResult(Name alias, Table<VocResearchResultRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table());
    }

    public <O extends Record> VocResearchResult(Table<O> child, ForeignKey<O, VocResearchResultRecord> key) {
        super(child, key, VOC_RESEARCH_RESULT);
    }
    ...
    @Override
    public VocResearchResult as(String alias) {
        return new VocResearchResult(DSL.name(alias), this);
    }

    @Override
    public VocResearchResult as(Name alias) {
        return new VocResearchResult(alias, this);
    }
     ...
     */
    @Override
    public VocResearchResult rename(String name) {
        return new VocResearchResult(DSL.name(name), null);
    }
     ...
     */
    @Override
    public VocResearchResult rename(Name name) {
        return new VocResearchResult(name, null);
    }
}
