...
public class EicnCdr extends TableImpl<EicnCdrRecord> {
    ...
    private static final long serialVersionUID = 1371682479;

    /**
     * The reference instance of <code>CUSTOMDB.eicn_cdr</code>
     */
     ...
     */
    public final TableField<EicnCdrRecord, String> INI_NUM = createField(DSL.name("ini_num"), org.jooq.impl.SQLDataType.VARCHAR(50).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "인바운드-첫인입대표 아웃바운드-발신CID");
     ...
     */
    public final TableField<EicnCdrRecord, String> WORKTIME_YN = createField(DSL.name("worktime_yn"), org.jooq.impl.SQLDataType.CHAR(1).defaultValue(org.jooq.impl.DSL.inline("Y", org.jooq.impl.SQLDataType.CHAR)), this, "업무시간여부");

    /**
     * The column <code>CUSTOMDB.eicn_cdr.stat_yn</code>. 통계쌓을지여부
     */
    public final TableField<EicnCdrRecord, String> STAT_YN = createField(DSL.name("stat_yn"), org.jooq.impl.SQLDataType.CHAR(1).defaultValue(org.jooq.impl.DSL.inline("Y", org.jooq.impl.SQLDataType.CHAR)), this, "통계쌓을지여부");
    ...
    /**
     * Create a <code>CUSTOMDB.eicn_cdr</code> table reference
     */
    public EicnCdr() {
    ...
    /**
     * Create an aliased <code>CUSTOMDB.eicn_cdr</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.EICN_CDR_CALLSTATUS, Indexes.EICN_CDR_COMPANY_ID, Indexes.EICN_CDR_DST, Indexes.EICN_CDR_DST_UNIQUEID, Indexes.EICN_CDR_RING_DATE, Indexes.EICN_CDR_SRC, Indexes.EICN_CDR_TURN_OVER_NUMBER, Indexes.EICN_CDR_UNIQUEID);
    }
