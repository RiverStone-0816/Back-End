                ...
                <div class="prof-info">
                    <svg width="16" height="14.5" viewBox="0 0 16 14.5">
                        <g id="Icon_feather-user" data-name="Icon feather-user" transform="translate(0.66 0.5)">
                            <path d="M21,26.987v-1.5c0-1.652-1.679-2.991-3.75-2.991H9.75C7.679,22.5,6,23.839,6,25.491v1.5" transform="translate(-6.16 -12.987)" fill="#39374d" stroke="#39374d"
                                  stroke-width="1"/>
                            <path d="M17.983,7.491A2.991,2.991,0,1,1,14.991,4.5,2.991,2.991,0,0,1,17.983,7.491Z" transform="translate(-7.651 -4.5)" fill="#39374d" stroke="#39374d"
        ...
        <div class="end">
            <c:if test="${hasExtension && isStat}">
                <div class="ui buttons small top-ivr-groups">
                    <button class="ui button" id="status-keeping-time">00:00</button>
                    <button class="ui button -call-receive">
                        <svg width="21.542" height="21.58" viewBox="0 0 21.542 21.58">
                            <path id="Icon_feather-phone-call" data-name="Icon feather-phone-call"
                                  ...
                                  transform="translate(-2.417 -0.672)" fill="none" stroke="#333" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
                        </svg>
                    </button>
                    <button class="ui button -call-pickup">
                        <svg width="21.773" height="21.812" viewBox="0 0 21.773 21.812">
                            <g id="Icon_feather-phone-outgoing" data-name="Icon feather-phone-outgoing" transform="translate(-2.417 -0.439)">
                                <path d="M31.234,7.234V1.5H25.5" transform="translate(47.674 9.689) rotate(180)" fill="none" stroke="#333" stroke-linecap="round" stroke-linejoin="round"
                                      stroke-width="1.5"/>
                                <path d="M24,8.19,30.69,1.5" transform="translate(47.129 9.689) rotate(180)" fill="none" stroke="#333" stroke-linecap="round" stroke-linejoin="round"
                                      stroke-width="1.5"/>
                                <path d="M22.174,17.258v2.867a1.911,1.911,0,0,1-2.083,1.911A18.912,18.912,0,0,1,11.843,19.1a18.635,18.635,0,0,1-5.734-5.734A18.912,18.912,0,0,1,3.176,5.083,1.911,1.911,0,0,1,5.077,3H7.944A1.911,1.911,0,0,1,9.856,4.644a12.27,12.27,0,0,0,.669,2.685,1.911,1.911,0,0,1-.43,2.016L8.881,10.559a15.29,15.29,0,0,0,5.734,5.734l1.214-1.214a1.911,1.911,0,0,1,2.016-.43,12.271,12.271,0,0,0,2.685.669,1.911,1.911,0,0,1,1.644,1.94Z"
                                      transform="translate(0 -0.544)" fill="none" stroke="#333" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
                            </g>
                        </svg>
                    </button>
                    <button class="ui button -call-hold">
                    ...
                    <button class="ui button"> <%--TODO: 호전환 버튼, 클릭시 --%>
                        ...
                        <svg width="22" height="22" viewBox="0 0 23.103 24.871">
                            <g transform="translate(-367.441 -125.097)">
                                <g id="Icon_feather-bell" data-name="Icon feather-bell" transform="translate(364.5 123)">
                                    <path d="M21.386,9.754a6.754,6.754,0,1,0-13.508,0c0,7.88-3.377,10.131-3.377,10.131H24.763s-3.377-2.251-3.377-10.131" fill="none" stroke="#333"
                                          stroke-linecap="round"
                                          stroke-linejoin="round" stroke-width="1.5"/>
                                    <path d="M19.3,31.5a2.251,2.251,0,0,1-3.895,0" transform="translate(-2.721 -7.112)" fill="none" stroke="#333" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-width="1.5"/>
                                </g>
