...
<form:form modelAttribute="form" cssClass="ui modal -json-submit" data-method="post"
           action="${pageContext.request.contextPath}/api/talk-schedule-week/"
           data-before="prepareWriteFormData" data-done="reload">

    <i class="close icon"></i>
    <div class="header">채팅상담주간스케쥴러[추가]</div>
    ...
    <div class="scrolling content rows">
        <div class="ui grid">
            ...
            <div class="row">
                <div class="eight wide column"><label class="control-label">채팅상담서비스리스트</label></div>
