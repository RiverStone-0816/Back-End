...
<form:form modelAttribute="form" class="ui modal -json-submit" data-method="put"
           action="${pageContext.request.contextPath}/api/talk-schedule-week/service/type/${entity.seq}" data-done="reload">

    <i class="close icon"></i>
    <div class="header">채팅상담주간스케쥴러[수정]</div>
    ...
    <div class="scrolling content rows">
        <div class="ui grid">
            ...
            <div class="row">
                <div class="four wide column"><label class="control-label">채팅상담서비스</label></div>
            ...
            <div class="row">
                ...
                <div class="four wide column">${g.messageOf("DayOfWeek", fn:substring(entity.week, 1, fn:length(entity.week)))}</div>
