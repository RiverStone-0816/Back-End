...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/talk/schedule/day/"/>
        <div class="sub-content ui container fluid unstackable">
            <form:form id="search-form" modelAttribute="search" method="get" class="panel panel-search">
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="panel-label">${g.htmlQuote(menu.getMenuName("/admin/talk/schedule/day/"))}</div>
                    </div>
    ...
    <tags:scripts>
        <script>
            function popupHolidayBatchModal() {
                popupReceivedHtml('/admin/talk/schedule/day/modal-holiday-batch', 'modal-holiday-batch');
            }

            function popupScheduleInfoModal(seq) {
                popupReceivedHtml('/admin/talk/schedule/day/' + (seq || 'new') + '/modal-schedule-info', 'modal-schedule-info');
            }

            function popupViewScheduleGroupModal(parent) {
                popupReceivedHtml('/admin/talk/schedule/day/modal-view-schedule-group?parent=' + parent, 'modal-view-schedule-group');
            }

            function deleteEntity(senderKey) {
                confirm('정말 삭제하시겠습니까?').done(function () {
                    restSelf.delete('/api/talk-schedule-day/' + encodeURIComponent(senderKey)).done(function () {
                        reload();
                    });
                });
            }
