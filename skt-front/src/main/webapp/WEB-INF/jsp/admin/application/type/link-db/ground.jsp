...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <div class="menu-tab">
            <div class="inner">
                <ul>
                    <li><a href="<c:url value="/admin/application/type/main-db/"/>" class="tab-indicator">고객DB유형</a></li>
                    <li><a href="<c:url value="/admin/application/type/link-db/"/>" class="tab-on tab-indicator">연동DB유형</a></li>
                    <li><a href="<c:url value="/admin/application/type/consultation-results/"/>" class="tab-indicator">상담결과유형</a></li>
                </ul>
                <div class="ui breadcrumb">
                    <span class="section">상담어플리케이션</span>
                    <i class="right angle icon divider"></i>
                    <span class="section">유형관리</span>
                    <i class="right angle icon divider"></i>
                    <span class="active section">연동DB유형</span>
                </div>
            </div>
        </div>
    ...
    <tags:scripts>
        <script>
            function popupModal(seq) {
                popupReceivedHtml('/admin/application/type/link-db/' + (seq || 'new') + '/modal', 'modal-type');
            }

            function popupUpdateSequenceFieldsModal(seq) {
                popupReceivedHtml('/admin/application/type/link-db/' + seq + '/modal-update-sequence-fields', 'modal-update-sequence-fields');
            }
