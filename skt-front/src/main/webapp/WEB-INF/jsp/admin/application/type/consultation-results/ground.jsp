...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/application/type/consultation-results/"/>
        <div class="sub-content ui container fluid unstackable">
            <div class="panel panel-search">
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="panel-label">${g.htmlQuote(menu.getMenuName("/admin/application/type/consultation-results/"))}</div>
                    </div>
                </div>
            </div>
            <div class="panel">
    ...
    <tags:scripts>
        <script>
            function popupModal(seq) {
                popupReceivedHtml('/admin/application/type/consultation-results/' + (seq || 'new') + '/modal', 'modal-type');
            }

            function popupUpdateSequenceFieldsModal(seq) {
                popupReceivedHtml('/admin/application/type/consultation-results/' + seq + '/modal-update-sequence-fields', 'modal-update-sequence-fields');
            }
