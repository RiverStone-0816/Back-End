...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/application/sms/message-history/"/>
        <div class="sub-content ui container fluid unstackable">
            ...
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href="<c:url value="/admin/application/sms/message-history/_excel?${g.escapeQuote(search.query)}"/>" class="ui green basic button">Excel 다운로드</a>
                    </div>
                </div>
                <div class="panel-body">
                ...
                <div class="panel-footer">
                    <tags:pagination navigation="${pagination.navigation}" url="${pageContext.request.contextPath}/admin/application/sms/message-history/" pageForm="${search}"/>
                </div>
            </div>
        </div>
    </div>
