        ...
        <div class="sub-content ui container fluid unstackable">
            <form:form id="search-form" modelAttribute="search" method="get" class="panel panel-search">
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="panel-label">${g.htmlQuote(menu.getMenuName("/admin/application/maindb/group/"))}</div>
                    </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body" style="overflow-x: auto;">
                    <table class="ui celled table structured border-top num-tbl unstackable num-tbl ${pagination.rows.size() > 0 ? "selectable-only" : null}" data-entity="MaindbGroup">
                        <thead>
                        <tr>
                            <th rowspan="2">선택</th>
                            <th rowspan="2">번호</th>
