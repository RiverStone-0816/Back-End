...
<tags:tabContentLayout>
        ...
        <div class="sub-content ui container fluid unstackable">
            <div class="panel panel-search">
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="panel-label">${g.htmlQuote(menu.getMenuName("/admin/record/file/enc/"))}</div>
                    </div>
                </div>
            </div>
            <div class="panel">
    ...
    <div class="ui modal small" id="enc-set-modal">
        ...
        <div class="actions">
            ...
            <button class="ui brand button" onclick="updateCurrentEncryptionType()">저장</button>
        </div>
    </div>
