...
<div id="evaluation-form">
    <table class="ui celled table compact unstackable structured relative">
        ...
        <c:choose>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${item.remark != null && item.remark != ''}">
                                    <div class="tooltip rating-description">
                                        ...
                                        <span class="tooltiptext" style="white-space: pre">${g.htmlQuote(item.remark)}</span>
                                    </div>
                                </c:if>
                            ...
                            <td>
                                <div class="ui form fluid">
                                    <input type="text" name="scores.${item.id}" data-name="score" data-max="${item.maxScore}" value="0" class="-input-numerical"/>
                                </div>
                            </td>
                        </tr>
                    </c:forEach>
            ...
            <c:otherwise>
                <tr>
                    <td colspan="5">평가항목이 등록되지 않았습니다.</td>
                </tr>
            </c:otherwise>
        </c:choose>
        </tbody>
