...
<%@ page import="kr.co.eicn.ippbx.model.enums.NumberType" %>
<%--@elvariable id="type" type="kr.co.eicn.ippbx.model.enums.NumberType"--%>
        ...
        <div class="sub-content ui container fluid unstackable">
            <div class="panel panel-search">
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="panel-label">${g.htmlQuote(menu.getMenuName("/admin/user/tel/number/"))}</div>
                    </div>
                </div>
            </div>
            <div class="panel">
