...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/wtalk/group/auto-comment/"/>
    ...
    <tags:scripts>
        <script>
            function popupModal(seq) {
                popupReceivedHtml('/admin/wtalk/group/auto-comment/' + (seq || 'new') + '/modal', 'modal-talk-auto-comment');
            }

            function deleteEntity(seq) {
                confirm('정말 삭제하시겠습니까?').done(function () {
                    restSelf.delete('/api/wtalk-auto-comment/' + seq).done(function () {
                        reload();
                    });
                });
            }
