...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/wtalk/schedule/week/"/>
    ...
    <tags:scripts>
        <script>
            function popupScheduleInfoModal(seq) {
                popupReceivedHtml('/admin/wtalk/schedule/week/' + (seq || 'new') + '/modal-schedule-info', 'modal-schedule-info');
            }

            function popupViewScheduleGroupModal(parent) {
                popupReceivedHtml('/admin/wtalk/schedule/week/modal-view-schedule-group?parent=' + parent, 'modal-view-schedule-group');
            }

            function deleteEntity(senderKey) {
                confirm('정말 삭제하시겠습니까?').done(function () {
                    restSelf.delete('/api/wtalk-schedule-week/' + encodeURIComponent(senderKey)).done(function () {
                        reload();
                    });
                });
            }
