...
<form:form modelAttribute="form" cssClass="ui modal tiny -json-submit" data-method="post"
           action="${pageContext.request.contextPath}/api/outbound-type/"
           data-done="reload">

    <i class="close icon"></i>
    <div class="header">유형추가[상담결과]</div>

    <div class="content rows">
        <div class="ui grid">
            <form:hidden path="kind"/>
            <form:hidden path="type" value="OUT"/>
            <div class="row">
            ...
            <div class="row">
                <div class="four wide column"><label class="control-label">용도지정</label></div>
                <div class="twelve wide column">
                    <div class="ui form">
