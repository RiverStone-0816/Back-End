...
<form:form modelAttribute="form" cssClass="ui modal tiny -json-submit" data-method="put"
           action="${pageContext.request.contextPath}/api/outbound-code/type/${type}/field/${entity.fieldId}/code"
    ...
    <div class="content rows scrolling">
        <div class="ui grid">
            ...
            <div class="row">
                <div class="three wide column"><label class="control-label">코드</label></div>
                <div class="three wide column">
                    <div class="ui input fluid">
                        <input type="text" name="codeId"/>
                    </div>
                </div>
                <div class="three wide column"><label class="control-label">코드명</label></div>
                <div class="three wide column">
                    <div class="ui input fluid">
