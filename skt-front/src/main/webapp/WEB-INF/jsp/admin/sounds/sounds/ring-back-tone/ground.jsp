        ...
        <div class="sub-content ui container fluid">
            <div class="panel panel-search">
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="panel-label">${g.htmlQuote(menu.getMenuName("/admin/sounds/sounds/ring-back-tone/"))}</div>
                    </div>
                </div>
            </div>
            <div class="panel">
                <div class="panel-heading">
                    <div class="pull-left">
                        ...
                        <div class="ui basic buttons">
                            ...
                            <button type="button" class="ui button -control-entity" data-entity="Moh" style="display: none;" onclick="deleteEntity(getEntityId('Moh'))">삭제</button>
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    <table class="ui celled table unstackable num-tbl ${pagination.rows.size() > 0 ? "selectable-only" : null}" data-entity="Moh">
                        <thead>
                        <tr>
                            <th>선택</th>
                            <th>번호</th>
