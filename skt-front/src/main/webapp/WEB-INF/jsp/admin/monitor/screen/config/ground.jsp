        ...
        <div class="sub-content ui container fluid">
            <div class="panel panel-search">
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="panel-label">${g.htmlQuote(menu.getMenuName("/admin/monitor/screen/config/"))}</div>
                    </div>
                </div>
            </div>
            <div class="panel">
                ...
                <div class="panel-body">
                    <table class="ui celled table num-tbl border-top unstackable ${list.size() > 0 ? "selectable-only" : null}" data-entity="ScreenConfig">
                        <thead>
                        <tr>
                            <th>번호</th>
                            <th>전광판명칭</th>
