            ...
            <div class="panel panel-statstics">
                ...
                <div class="panel-body">
                    <div class="panel-section">
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="pull-left"><h3 class="panel-title">전체 큐(그룹): <span class="text-primary">${queueSummaries.size()}</span></h3></div>
                                <div class="pull-right"> <button class="ui basic button" onclick="monitoringHuntSelect()">큐선택</button></div>
                            </div>
                            <div class="panel-body">
                    ...
                    <div class="panel-section">
                        <div class="panel-sub-title">큐그룹별 모니터링</div>
