                        ...
                        <div class="equal width row flex-130">
                            <div class="column">
                                <div class="board-box incoming-call full-height">
                                    ...
                                    <div class="board-number large compact flex-160">185</div>
                                </div>
                            </div>
                            <div class="column">
                                <div class="board-box connection-request full-height">
                                    <div class="board-title flex-100">연결요청</div>
                                    <div class="board-number large compact flex-160">20</div>
                                </div>
                            </div>
                        </div>
                        <div class="row flex-100 remove-pb">
                            <div class="column">
                                <div class="board-box reception full-height">
                                    ...
                                    <div class="board-number compact flex-140">185</div>
                                </div>
                            </div>
                            <div class="column">
                            ...
                            <div class="column">
                                <div class="board-box response-rate full-height">
                                    ...
                                    <div class="board-number compact flex-140">100%</div>
                                </div>
                            </div>
                        </div>
                    </div>
