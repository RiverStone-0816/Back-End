...
import kr.co.eicn.ippbx.front.service.api.wtalk.statistics.WtalkDailyStatApiInterface;
...
@LoginRequired
@Controller
@RequestMapping("admin/wtalk/statistics/daily")
public class WtalkDailyStatController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(WtalkDailyStatController.class);

    @Autowired
    private WtalkDailyStatApiInterface apiInterface;
    @Autowired
    ...
    public String page(Model model, @ModelAttribute("search") TalkStatisticsSearchRequest search) throws IOException, ResultFailException {
        final List<WtalkStatisticsDailyResponse> list = apiInterface.list(search);
        ...
        return "admin/wtalk/statistics/daily/ground";
    }
