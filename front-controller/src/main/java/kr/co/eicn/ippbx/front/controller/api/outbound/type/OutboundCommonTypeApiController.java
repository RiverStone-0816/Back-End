...
@RestController
@RequestMapping(value = "api/outbound-type", produces = MediaType.APPLICATION_JSON_VALUE)
public class OutboundCommonTypeApiController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(OutboundCommonTypeApiController.class);
