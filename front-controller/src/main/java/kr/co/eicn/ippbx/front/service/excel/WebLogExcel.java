...
public class WebLogExcel extends AbstractExcel {
    ...
    public WebLogExcel(List<WebSecureHistoryResponse> list) {
        this.list = list;
        createBody();
    }
    ...
    private void createBody() {
        ...
        for (WebSecureHistoryResponse e : list) {
            addRow(defaultStyle,
                   ...
                   niceFormat(g.messageOf("WebSecureActionType", e.getActionId())),
                   niceFormat(g.messageOf("WebSecureActionSubType",e.getActionSubId())),
