...
@LoginRequired
@Controller
@RequestMapping("admin/outbound/type/preview-type")
public class OutboundPreviewTypeController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(OutboundPreviewTypeController.class);
    ...
    public String page(Model model) throws IOException, ResultFailException {
        final List<CommonTypeEntity> list = apiInterface.list(CommonTypeKind.PREVIEW.getCode());
        model.addAttribute("list", list);
        return "admin/outbound/type/preview-type/ground";
    }
    ...
    public String modal(Model model, @ModelAttribute("form") CommonTypeFormRequest form) throws IOException, ResultFailException {
        ...
        return "admin/outbound/type/preview-type/modal-new-type";
    }
    ...
    public String modal(Model model, @ModelAttribute("form") CommonTypeUpdateFormRequest form, @PathVariable Integer seq) throws IOException, ResultFailException {
        ...
        final List<CommonBasicField> basicFields = apiInterface.getBasicFields(CommonTypeKind.PREVIEW.getCode());
        ...
        return "admin/outbound/type/preview-type/modal-update-type";
    }
    ...
    public String modal(Model model, @PathVariable Integer seq) throws IOException, ResultFailException {
        ...
        return "admin/outbound/type/preview-type/modal-update-sequence-fields";
    }
}
