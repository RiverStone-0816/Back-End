...
@Service
public class InboundWeekScheduleApiInterface extends ApiServerInterface {
    private static final Logger logger = LoggerFactory.getLogger(InboundWeekScheduleApiInterface.class);
    private static final String subUrl = "/api/v1/admin/sounds/schedule/inbound/week/";
    ...
    public void post(ScheduleInfoFormRequest form) throws IOException, ResultFailException {
        post(subUrl, form);
    }
    ...
    public void updateType(Integer seq, ScheduleInfoUpdateFormRequest form) throws IOException, ResultFailException {
