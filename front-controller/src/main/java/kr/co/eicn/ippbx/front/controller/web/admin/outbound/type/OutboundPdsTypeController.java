...
@LoginRequired
@Controller
@RequestMapping("admin/outbound/type/pds-type")
public class OutboundPdsTypeController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(OutboundPdsTypeController.class);
    ...
    public String page(Model model) throws IOException, ResultFailException {
        final List<CommonTypeEntity> list = apiInterface.list(CommonTypeKind.PDS.getCode());
        model.addAttribute("list", list);
        return "admin/outbound/type/pds-type/ground";
    }
    ...
    public String modal(Model model, @ModelAttribute("form") CommonTypeFormRequest form) throws IOException, ResultFailException {
        ...
        return "admin/outbound/type/pds-type/modal-new-type";
    }
    ...
    public String modal(Model model, @ModelAttribute("form") CommonTypeUpdateFormRequest form, @PathVariable Integer seq) throws IOException, ResultFailException {
        ...
        final List<CommonBasicField> basicFields = apiInterface.getBasicFields(CommonTypeKind.PDS.getCode());
        ...
        return "admin/outbound/type/pds-type/modal-update-type";
    }
    ...
    public String modal(Model model, @PathVariable Integer seq) throws IOException, ResultFailException {
        ...
        return "admin/outbound/type/pds-type/modal-update-sequence-fields";
    }
}
