...
@LoginRequired
@Controller
@RequestMapping("admin/service/help/manual")
public class ManualController extends BaseController {
    ...
    public String page(Model model, @ModelAttribute("search") BoardSearchRequest search) throws IOException, ResultFailException {
        ...
        return "admin/service/help/manual/ground";
    }

    @GetMapping("new/modal")
    public String modal(Model model, @ModelAttribute("form") ManualForm form) throws IOException, ResultFailException {
        return "admin/service/help/manual/modal";
    }

    @GetMapping("{id}/modal")
    public String modal(Model model, @PathVariable Long id, @ModelAttribute("form") ManualForm form) throws IOException, ResultFailException {
        final ManualDetailResponse entity = apiInterface.get(id);
    ...
    public String modal(Model model, @PathVariable Long id) throws IOException, ResultFailException {
        final ManualDetailResponse entity = apiInterface.getDetail(id);
        model.addAttribute("entity", entity);

        return "admin/service/help/manual/modal-show";
    }
}
