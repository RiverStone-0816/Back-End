...
@RestController
@RequestMapping(value = "api/wtalk-schedule-week", produces = MediaType.APPLICATION_JSON_VALUE)
public class WtalkWeekScheduleApiController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(WtalkWeekScheduleApiController.class);

    @Autowired
    private WtalkWeekScheduleApiInterface apiInterface;
