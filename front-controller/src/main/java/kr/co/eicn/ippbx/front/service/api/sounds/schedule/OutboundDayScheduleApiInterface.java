...
@Service
public class OutboundDayScheduleApiInterface extends ApiServerInterface {
    private static final Logger logger = LoggerFactory.getLogger(OutboundDayScheduleApiInterface.class);
    private static final String subUrl = "/api/v1/admin/sounds/schedule/outbound/day/";
    ...
    public void update(Integer parent, DayOutScheduleSeedFormRequest form) throws IOException, ResultFailException {
