...
public class MaindbResultApiInterface extends ApiServerInterface {
    ...
    public Pagination<ResultCustomInfoEntity> getPaginationCounsel(Integer groupSeq, ResultCustomInfoSearchRequest search) throws IOException, ResultFailException {
        final Map<String, Object> param = objectMapper.convertValue(search, typeFactory.constructParametricType(Map.class, String.class, Object.class));
        ...
        return getPagination(subUrl + groupSeq + "/data/counsel", param, ResultCustomInfoEntity.class).getData();
    }
