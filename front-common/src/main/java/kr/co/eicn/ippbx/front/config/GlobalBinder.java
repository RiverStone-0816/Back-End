...
public class GlobalBinder {
    ...
    public Boolean devel(@Value("${user-data.application.debugging}") Boolean debugging) {
    ...
    public String serviceUrl(@Value("${user-data.application.version}") String serviceUrl) {
        return serviceUrl;
    }

    @ModelAttribute("cipherKey")
    public String cipherKey(@Value("${user-data.application.version}") String cipherKey) {
        return cipherKey;
    }

    @ModelAttribute("apiServerUrl")
    public String apiServerUrl(@Value("${user-data.application.debugging}") String apiServerUrl) {
        return apiServerUrl;
    }

    @ModelAttribute("serviceKind")
    public String serviceKind(@Value("${user-data.application.debugging}") String serviceKind) {
        return serviceKind;
    }

    @ModelAttribute("accessToken")
    public String accessToken(HttpSession session, SessionStorage storage) {
