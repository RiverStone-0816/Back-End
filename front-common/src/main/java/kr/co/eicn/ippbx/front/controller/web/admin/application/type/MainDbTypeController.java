...
@LoginRequired
@Controller
@RequestMapping("admin/application/type/main-db")
public class MainDbTypeController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(MainDbTypeController.class);
    ...
    public String page(Model model) throws IOException, ResultFailException {
        final List<CommonTypeEntity> list = apiInterface.list(CommonTypeKind.MAIN_DB.getCode());
        model.addAttribute("list", list);
        return "admin/application/type/main-db/ground";
    }
    ...
    public String modal(Model model, @ModelAttribute("form") CommonTypeFormRequest form) throws IOException, ResultFailException {
        ...
        return "admin/application/type/main-db/modal-new-type";
    }
    ...
    public String modal(Model model, @ModelAttribute("form") CommonTypeUpdateFormRequest form, @PathVariable Integer seq) throws IOException, ResultFailException {
        ...
        final List<CommonBasicField> basicFields = apiInterface.getBasicFields(CommonTypeKind.MAIN_DB.getCode());
        ...
        return "admin/application/type/main-db/modal-update-type";
    }
    ...
    public String modal(Model model, @PathVariable Integer seq) throws IOException, ResultFailException {
        ...
        return "admin/application/type/main-db/modal-update-sequence-fields";
    }
}
