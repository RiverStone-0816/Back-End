                        ...
                        <div class="chat">
                            ...
                            <div class="chat-layer">
                                <div class="buttons">
                                    ...
                                    <button type="button" class="button-knowledge" data-inverted="" data-tooltip="지식관리 호출" data-position="bottom center" onclick="knowledgeCall();"></button>
    ...
    <div class="scrolling content rows bg-gray">
        <div class="ui grid">
            <div class="content-wrapper-frame">
                <form id="search-form" class="panel panel-search" action="/admin/service/help/task-script/" method="get">
...
<tags:scripts>
    <script>
        ...
        function knowledgeCall() {
            $('#knowledge-call-popup').dragModalShow();
        }

        function knowledgeManageModify() {
            $('#knowledge-modiffy-popup').modalShow();
        }
        ...
        function imgViewPopup() {
            $('#img-view-popup').modalShow();
        }
