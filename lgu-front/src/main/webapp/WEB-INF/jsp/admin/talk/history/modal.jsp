                                                                        ...
                                                                        <c:choose>
                                                                            ...
                                                                            <c:when test="${k.type.code=='image' && k.type != null}">
                                                                                <div class="chat">
                                                                                    <div class="bubble">
                                                                                        <p class="txt_chat">
                                                                                            <img src="'${pageContext.request.contextPath}/admin/wtalk/chat-bot/image?fileName=' + encodeURIComponent(k.elementList.get(0).image)">
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </c:when>
                                                    ...
                                                    <c:when test="${ e.blockInfo.displayList.get(0).elementList.get(0).image!=null}">
                                                        <div class="chat bot">
                                                            <div class="bubble">
                                                                <div>
                                                                    <div class="card-img">
                                                                        <img src="'${pageContext.request.contextPath}/admin/wtalk/chat-bot/image?fileName=' + encodeURIComponent(e.blockInfo.displayList.get(0).elementList.get(0).image">
                                                                    </div>
