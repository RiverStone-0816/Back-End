...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/record/file/file/"/>
                            ...
                            <c:when test="${list.size() > 0}">
                                <c:forEach var="e" items="${list}" varStatus="status">
                                    <tr data-id="${g.htmlQuote(e.fileName)}">
                                        ...
                                        <td>
                                            <a class="ui icon button mini compact" href="${pageContext.request.contextPath}/api/record-file/resource-disk?fileName=${g.htmlQuote(e.fileName)}">
        ...
        <script>
            ...
            function deleteEntity(fileName) {
                confirm('정말 삭제하시겠습니까?').done(function () {
                    restSelf.delete('/api/record-file/' + encodeURIComponent(fileName)).done(function () {
                        reload();
                    });
                });
            }
