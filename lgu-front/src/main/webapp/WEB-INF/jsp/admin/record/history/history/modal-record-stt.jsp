...
<div class="ui modal inverted small">
  ...
  <div class="sixteen wide column talk-room">
    <div id="stt-record-history-panel" class="chat-container overflow-hidden">
      <div class="room">
...
<script>
  ...
  const callRecordHistoryProperties = {
    setup: function () {
      return {
        ME: userId,
        REPLYING_INDICATOR: '\u001b',
    ...
    methods: {
      ...
      loadRoom: function () {
        const _this = this
        return restSelf.get('/api/counsel/stt-text/' + this.uniqueId).done(function (response) {
  ...
  const sttRecordHistoryPanel = Vue.createApp(Object.assign({}, callRecordHistoryProperties)).mount('#stt-record-history-panel')
