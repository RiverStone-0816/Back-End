...
<form:form commandName="form" cssClass="ui modal -json-submit" data-method="${entity == null ? 'post' : 'put'}"
           action="${pageContext.request.contextPath}/api/email-reception-group/${entity == null ? null : entity.groupId}"
           data-before="prepareWriteFormData" data-done="reload">

    <i class="close icon"></i>
    <div class="header">이메일그룹[${entity != null ? '수정' : '추가'}]</div>

    <div class="content rows scrolling">
        <div class="ui grid">
            <div class="row">
                <div class="four wide column"><label class="control-label">이메일그룹명</label></div>
                <div class="four wide column">
                    <div class="ui input fluid"><form:input path="groupName"/></div>
                </div>
                <div class="four wide column"><label class="control-label">관련이메일서비스</label></div>
                <div class="four wide column">
                    <div class="ui form">
                        <form:select path="emailId">
            ...
            <div class="row">
                <div class="sixteen wide column">
                    <div class="jp-multiselect -moving-container">
                        ...
                        <div class="to-panel">
                            <select name="emailMemberLists" class="form-control -right-selector" size="8" multiple="multiple">
                                <c:forEach var="e" items="${entity.emailMemberLists}">
...
<script>
    window.prepareWriteFormData = function (data) {
        data.emailMemberLists = [];
        modal.find('[name="emailMemberLists"] option').each(function () {
            data.emailMemberLists.push($(this).val());
        });
    };
</script>
