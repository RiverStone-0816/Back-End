...
<form:form modelAttribute="form" cssClass="ui modal -json-submit" data-method="post"
           action="${pageContext.request.contextPath}/api/notice/${entity == null ? null : entity.id}"
           data-before="prepareWriteFormData" data-done="reload">

    <i class="close icon"></i>
    <div class="header">공지사항[${entity != null ? '수정' : '추가'}]</div>
    ...
    <div class="scrolling content rows">
        <div class="ui grid">
            ...
            <div class="row">
                <div class="three wide column"><label class="control-label">공지등록</label></div>
                <div class="seven wide column">
                    <div class="grouped fields">
                        <c:forEach var="e" items="${noticeTypes}">
                            <div class="field">
                                <div class="ui radio checkbox">
                                    <form:radiobutton path="noticeType" value="${e.key}" class="hidden"/>
                        ...
                        <div class="ui list" data-count="${entity != null ? entity.fileInfo.size() : 0}">
                            <c:forEach var="file" items="${entity.fileInfo}">
                                <div class="item">
                                    ...
                                    <a target="_blank" href="${pageContext.request.contextPath}/api/notice/id/${file.id}/resource">${g.htmlQuote(file.originalName)}</a>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
