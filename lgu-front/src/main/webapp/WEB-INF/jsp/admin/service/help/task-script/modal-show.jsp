    ...
    <div class="scrolling content rows">
        <div class="ui grid">
                ...
                <div class="thirteen wide column">
                    <div class="ui input fluid">
                        <div class="form-group">
                            <input class="-tagify" readonly value="${g.htmlQuote(entity.tag)}"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="thirteen wide column">
                    <div class="board-con-inner" style="white-space: pre-wrap;">${g.htmlQuote(entity.content)}</div>
                </div>
            </div>
                        ...
                        <div class="ui list filelist">
                            <c:forEach var="e" items="${entity.fileInfo}">
                                <div class="item">
                                    ...
                                    <div class="content">
                                        <a href="${apiServerUrl}/api/v1/admin/help/script/${e.id}/specific-file-resource?token=${accessToken}" target="_blank">
