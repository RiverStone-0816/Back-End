        ...
        <div class="search-area">
            <div class="ui grid">
                <div class="row">
                    ...
                    <div class="fourteen wide column -buttons-set-range-container" data-startdate="[name=startDate]"
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="ui secondary  menu">
            ...
            <c:forEach var="e" items="${categories}">
                <a href="javascript: changeCategory(${e.key})"
                   class="item ${search.categoryId == e.key ? 'active' : null}">${g.htmlQuote(e.value)}</a>
            </c:forEach>
        </div>
        <table class="ui celled table compact unstackable fixed ${pagination.rows.size() > 0 ? 'selectable-only' : null}"
               data-entity="TaskScript">
            <thead>
            <tr>
    ...
    <div class="panel-footer">
        <tags:pagination navigation="${pagination.navigation}"
                         url="${pageContext.request.contextPath}/admin/service/help/task-script/" pageForm="${search}"
