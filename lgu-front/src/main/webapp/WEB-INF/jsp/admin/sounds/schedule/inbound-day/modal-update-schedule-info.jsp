...
<form:form modelAttribute="form" class="ui modal -json-submit" data-method="put"
           action="${pageContext.request.contextPath}/api/inbound-day-schedule/service/type/${entity.scheduleInfo.seq}" data-done="reload">

    <i class="close icon"></i>
    <div class="header">일별스케쥴러[수정]</div>
                ...
                <div class="four wide column">
                    <div class="date-picker">
                        <div class="dp-wrap">
                            ...
                            <form:input path="fromDate" cssClass="-datepicker" placeholder="날짜"/>
                        </div>
                    </div>
                </div>
...
<script>
    modal.find('[name=groupId]').change(function () {
        ...
        if (this.value !== '') {
            receiveHtml(contextPath + '/admin/sounds/schedule/inbound-day/modal-view-schedule-group?parent=' + this.value).done(function (html) {
