...
<form:form commandName="form" cssClass="ui modal small -json-submit" data-method="post"
           action="${pageContext.request.contextPath}/api/pds-group/${entity.seq}/fields/by-excel"
    ...
    <div class="content rows scrolling">
        <div class="ui grid">
            ...
            <div class="row">
                ...
                <div class="twelve wide column">${g.htmlQuote(entity.pdsTypeName)}</div>
            </div>
            <div class="row">
                <div class="four wide column"><label class="control-label">유형업로드필드</label></div>
                <div class="twelve wide column">
                    <c:forEach var="e" items="${commonTypeEntity.fields}">
                        <text style="display: inline-block; margin-right: 1em;">${g.htmlQuote(e.fieldInfo)}[${g.htmlQuote(e.fieldType)}]</text>
                    </c:forEach>
                </div>
            </div>
            <div class="row">
