...
<form:form commandName="form" cssClass="ui modal small -json-submit" data-method="${entity != null ? 'put' : 'post'}"
           action="${pageContext.request.contextPath}/api/preview-result/${entity != null ? g.htmlQuote(entity.seq) : null}"
           data-before="prepareWriteFormData" data-done="reload">

    <i class="close icon"></i>
    <div class="header">프리뷰 결과이력 ${entity != null ? '수정' : '추가'} [그룹명:${g.htmlQuote(previewGroup.name)}]</div>
                ...
                <div class="row">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${field.fieldType == 'DATETIME'}">
                            <div class="twelve wide column">
                                <div class="ui form fluid">
                                    <input type="text" name="${name}" multiple="multiple" value="${value != null ? g.dateFormat(value) : null}" class="-datepicker" style="width: 100px"/>&ensp;
