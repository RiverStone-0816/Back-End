...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/acd/grade/vip/"/>
        <div class="sub-content ui container fluid unstackable">
            ...
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <div class="ui basic buttons">
                            ...
                            <button class="ui basic button -control-entity" data-entity="VipRouting" style="display: none;" onclick="popupModal(getEntityId('VipRouting'))">수정</button>
                            <button class="ui basic button -control-entity" data-entity="VipRouting" style="display: none;" onclick="deleteEntity(getEntityId('VipRouting'))">삭제</button>
                        </div>
                            ...
                            <c:when test="${pagination.rows.size() > 0}">
                                <c:forEach var="e" items="${pagination.rows}" varStatus="status">
                                    <tr data-id="${e.seq}">
                                        ...
                                        <td>${g.htmlQuote(g.messageOf('RouteType', e.type))}</td>
                                        <c:choose>
                ...
                <div class="panel-footer">
                    <tags:pagination navigation="${pagination.navigation}" url="${pageContext.request.contextPath}/admin/acd/grade/vip/" pageForm="${search}"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <tags:scripts>
        <script>
            function popupUploadModal() {
                popupReceivedHtml('/admin/acd/grade/vip/modal-upload', 'modal-upload');
            }
