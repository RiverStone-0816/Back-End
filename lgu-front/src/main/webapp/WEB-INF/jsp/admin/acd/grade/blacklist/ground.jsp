    ...
    <div class="content-wrapper-frame">
        ...
        <div class="sub-content ui container fluid unstackable">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <table class="ui celled table compact fixed unstackable num-tbl ${pagination.rows.size() > 0 ? "selectable-only" : null}" data-entity="BlacklistRouting">
                        <thead>
                        <tr>
    ...
    <tags:scripts>
        <script>
            ...
            function downloadExampleExcel() {
                window.open(contextPath + '/admin/acd/grade/blacklist/_excel/example', '_blank');
            }
