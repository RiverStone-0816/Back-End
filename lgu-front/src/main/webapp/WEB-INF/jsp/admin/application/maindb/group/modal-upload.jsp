    ...
    <div class="content rows scrolling">
        <div class="ui grid">
            ...
            <div class="row">
                ...
                <div class="twelve wide column">
                    [ 전화번호<c:if test="${g.usingServices.contains('EMAIL')}">, 이메일</c:if><c:if test="${g.usingServices.contains('TALK') || g.usingServices.contains('KATLK') || g.usingServices.contains('ECHBT')}">, 상담톡아이디</c:if>] 각각 여러개 컬럼 업로드가능
                </div>
            </div>
            <div class="row">
                <div class="four wide column">
                    ...
                    <i class="circular red info icon small comment-icon" title="※ 파일 업로드 주의사항 ※
                            1. 첫 행 필수 기입
                            2. 필수 기입 필드(빨간 배경) 누락 시, 데이터 업로드가 실패할 수 있습니다.
