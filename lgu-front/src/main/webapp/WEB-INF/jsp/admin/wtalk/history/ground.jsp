...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/wtalk/history/"/>
        <div class="sub-content ui container fluid unstackable">
            ...
            <div class="panel">
                ...
                <div class="panel-footer">
                    <tags:pagination navigation="${pagination.navigation}" url="${pageContext.request.contextPath}/admin/wtalk/history/" pageForm="${search}"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <tags:scripts>
        <script>
            function downloadExcel() {
                window.open(contextPath + '/admin/wtalk/history/_excel?${g.escapeQuote(search.query)}', '_blank');
            }

            function popupModal(seq, roomId, roomStatus) {
                popupReceivedHtml('/admin/wtalk/history/' + seq + '/modal?roomId=' + encodeURIComponent(roomId) + '&roomStatus=' + encodeURIComponent(roomStatus), 'modal-message-history');
            }
        </script>
    </tags:scripts>
</tags:tabContentLayout>
