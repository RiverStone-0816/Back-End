...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/wtalk/schedule/schedule-group/"/>
    ...
    <form id="modal-schedule-type-add" class="ui modal tiny -json-submit" data-method="post" action="<c:url value="/api/wtalk-schedule-group/"/>" data-done="reload">
        ...
        <script>
            ...
            function deleteScheduleGroup(parent) {
                confirm('정말 삭제하시겠습니까?').done(function () {
                    restSelf.delete('/api/wtalk-schedule-group/' + parent).done(function () {
                        reload();
                    });
                });
            }
            ...
            function deleteScheduleItem(child) {
                confirm('정말 삭제하시겠습니까?').done(function () {
                    restSelf.delete('/api/wtalk-schedule-group/item/' + child).done(function () {
                        reload();
                    });
                });
            }
            ...
            function popupScheduleItemModal(parent, child, channelType) {
                popupReceivedHtml('/admin/wtalk/schedule/schedule-group/' + parent + '/item/' + (child || 'new') + '/modal?channelType=' + channelType, 'modal-schedule-item');
            }
        </script>
    </tags:scripts>
</tags:tabContentLayout>
