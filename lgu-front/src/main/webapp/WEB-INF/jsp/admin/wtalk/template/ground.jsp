...
<tags:tabContentLayout>
    <div class="content-wrapper-frame">
        <tags:page-menu-tab url="/admin/wtalk/template/"/>
    ...
    <tags:scripts>
        <script>
            function popupModal(seq) {
                popupReceivedHtml('/admin/wtalk/template/' + (seq || 'new') + '/modal', 'modal-talk-template');
            }

            function deleteEntity(seq) {
                confirm('정말 삭제하시겠습니까?').done(function () {
                    restSelf.delete('/api/wtalk-template/' + seq).done(function () {
                        reload();
                    });
                });
            }
