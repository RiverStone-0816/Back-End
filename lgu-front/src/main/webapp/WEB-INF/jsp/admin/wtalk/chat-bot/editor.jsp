...
<tags:tabContentLayout>
                                                ...
                                                <div class="content editor">
                                                    <div v-for="(e,i) in displays" :class="e.type === 'text' ? 'sample-bubble' : 'card'">
                                                        ...
                                                        <div v-if="e.data && e.type === 'image'" class="card-img">
                                                            <img :src="`${pageContext.request.contextPath}/admin/wtalk/chat-bot/image?fileName=` + encodeURIComponent(e.data.fileUrl)" class="border-radius-1em">
                                                        </div>
                                                        <div v-if="e.data && e.type === 'card'" class="card-img">
                                                            <img :src="`${pageContext.request.contextPath}/admin/wtalk/chat-bot/image?fileName=` + encodeURIComponent(e.data.fileUrl)" class="border-radius-top-1em">
                                                        </div>
                                                                    ...
                                                                    <a :href="e2.url" target="_blank" class="link-wrap">
                                                                        <div class="item-thumb" v-if="e2.fileUrl && e2.fileUrl.trim()">
                                                                            <div class="item-thumb-inner">
                                                                                <img :src="`${pageContext.request.contextPath}/admin/wtalk/chat-bot/image?fileName=` + encodeURIComponent(e2.fileUrl)">
                                                                            </div>
                                                                        </div>
    ...
    <tags:scripts>
        ...
        <script>
                ...
                const o = Vue.createApp({
                    ...
                    methods: {
                        testPreviewLoad(botId) {
                            this.testUrl = contextPath + '/admin/wtalk/chat-bot/' + botId + '/modal-test'
                        }
                    }
                }).mount('#test-preview')
            ...
            restSelf.get('/api/wtalk-reception-group/').done(response => {
