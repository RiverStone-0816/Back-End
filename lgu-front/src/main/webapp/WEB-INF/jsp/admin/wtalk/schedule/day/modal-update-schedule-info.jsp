...
<form:form modelAttribute="form" class="ui modal -json-submit" data-method="put"
           action="${pageContext.request.contextPath}/api/wtalk-schedule-day/service/type/${entity.seq}" data-done="reload">
...
<script>
    modal.find('[name=groupId]').change(function () {
        ...
        if (this.value !== '') {
            receiveHtml(contextPath + '/admin/wtalk/schedule/day/modal-view-schedule-group?parent=' + this.value).done(function (html) {
